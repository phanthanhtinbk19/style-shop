...
<div class="container-fluid px-4">
	...
	<a href="http://localhost/style-shop-2022/UserAdmin/ViewAdd" class="btn btn-outline-primary">Add New Account</a>
	<div class="row mt-3">
				...
				<tbody>
					...
					foreach ($data["allUser"] as $user) { ?>
						<tr>
							...
							<td><a href="<?php echo 'http://localhost/style-shop-2022/UserAdmin/ViewEdit/' . $user['id']; ?>" class="editLink">Edit</a></td>
							<td><a class="delLink" href="<?php echo 'http://localhost/style-shop-2022/UserAdmin/deletedUser/' . $user['id']; ?>" style="color: #ff7782;">Delete</a></td>
						</tr>
					<?php } ?>
