...
<main>
	<h4>Edit Category</h4>
	<a href="http://localhost/style-shop-2022/CategoryAdmin" class="btn btn-outline-primary">Back to Category list</a>
	<form class="addForm" method="POST" action="http://localhost/style-shop-2022/CategoryAdmin/PostEdit">
